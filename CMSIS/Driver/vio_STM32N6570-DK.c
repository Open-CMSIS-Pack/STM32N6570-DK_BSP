/******************************************************************************
 * @file     vio_STM32N6570-DK.c
 * @brief    Virtual I/O implementation for board STM32N6570-DK
 * @version  V1.0.0
...
/*! \page vio_STM32N6570-DK Physical I/O Mapping

The table below lists the physical I/O mapping of this CMSIS-Driver VIO implementation.

| Virtual I/O   | Variable       | Board component      | Pin
|:--------------|:---------------|:---------------------|:------
| vioBUTTON0    | vioSignalIn.0  | Tamper button (B4)   | PE0
| vioBUTTON1    | vioSignalIn.1  | User1 button  (B2)   | PC13
| vioLED0       | vioSignalOut.0 | LED Red       (LD2)  | PG10
...
//  signal,     pin,                   pull resistor,      active state
  { vioLED0,    GPIO_PIN_ID_PORTG(10), ARM_GPIO_PULL_NONE, VIO_ACTIVE_LOW  },
...
//  signal,     pin,                   pull resistor,      active state
  { vioBUTTON0, GPIO_PIN_ID_PORTE(0),  ARM_GPIO_PULL_DOWN, VIO_ACTIVE_HIGH },
  { vioBUTTON1, GPIO_PIN_ID_PORTC(13), ARM_GPIO_PULL_DOWN, VIO_ACTIVE_HIGH }
};
#endif
