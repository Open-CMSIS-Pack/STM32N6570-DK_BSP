...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : PD1 PD12 ETH_MDINT_Pin */
  ...
  /*Configure GPIO pins : PF10 PF7 ETH_CLK_Pin PF15
                           PF14 ETH_RXD2_Pin ETH_CLK125_Pin ETH_RXD3_Pin
                           PF11 PF13 PF12 */
  ...
  /*Configure GPIO pins : ETH_TXD3_Pin ETH_TX2_Pin */
  ...
  /*Configure GPIO pin : ETH_GTX_CLK_Pin */
